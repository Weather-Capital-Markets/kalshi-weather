"""HTTP client for Polymarket US public market-data API."""
...
class PolymarketClient:
    def __init__(
        ...
        *,
        ...
        self.base_url = str(api.get("base_url") or "https://gateway.polymarket.us").rstrip("/")
        self.timeout_sec = float(api.get("timeout_sec", 15))
        self.max_retries = int(api.get("max_retries", 5))
        self._limiter = RateLimiter(float(api.get("max_requests_per_sec", 15)))
